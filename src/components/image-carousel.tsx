          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <p className="text-gray-700 text-lg leading-relaxed font-montserrat">
                Es importante <span className="font-semibold text-gray-900">conocer y respetar las normas</span> para que todos
                podamos disfrutar de una buena experiencia de juego. Si eres nuevo,
                te recomendamos <span className="font-semibold text-gray-900">leer las reglas y familiarizarte con la comunidad</span>.
                Si tienes dudas, el equipo de <span className="font-semibold text-gray-900">staff está disponible</span> para ayudarte.
              </p>
            </div>
