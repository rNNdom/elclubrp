...
export default function NormativaEMS() {
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Header Section */}
            <div className="relative h-96 flex items-center justify-center bg-gray-200" style={{borderRadius: '20px', backgroundImage: 'url(/banner.png)', backgroundSize: 'cover', backgroundPosition: 'center', margin: '20px'}}>
            ...
            <div className="relative -mt-8 px-6 z-20" style={{marginTop: '2px'}}>
                <div className="relative flex items-center">
                    <div className="relative flex items-center w-full gap-4">
                        ...
                        <div className="h-0.5 w-[570px] bg-gradient-to-r from-blue-500 via-purple-500 to-purple-700 rounded-full" />
                        ...
                        <div className="absolute left-1/2 -translate-x-1/2 bg-gray-200 rounded-2xl px-8 py-4 shadow-md" style={{ fontFamily: 'Montserrat' }}>
                            <h1 className="text-2xl text-center">
                                ...
                                <span className="text-orange-600 italic font-normal">EMS</span>
                            </h1>
                        </div>
                ...
                <div className="flex-1 space-y-6">
                    <div id="que-es">
                        ...
                        <p className="text-gray-800 leading-relaxed">
                            ...
                            Lorem Ipsum ha sido el texto de relleno estándar de la industria desde el año 1500, cuando un impresor 
                            desconocido tomó una galera de tipos y la mezcló para hacer un libro de muestras tipográficas.
                        </p>
                    </div>
                    ...
                    <div id="por-que">
                        ...
                        <p className="text-gray-800 leading-relaxed">
                            ...
                            de una página cuando mire su diseño. El punto de usar Lorem Ipsum es que tiene una distribución 
                            más o menos normal de las letras, al contrario de usar texto como "Contenido aquí, contenido aquí".
                        </p>
                    </div>
                    ...
                    <div id="origen">
                        ...
                        <p className="text-gray-800 leading-relaxed">
                            ...
                            Tiene sus raíces en una pieza de la literatura latina clásica del año 45 antes de Cristo, 
