...
<Content title='Reglas del cuerpo policial ' id='1' spaced>
              <ListItemContent
                items={[ 
                    ...
                    "Evaluación y rangos: Todos los oficiales deberán rendir exámenes de rango para ascender. Para rendir estos exámenes los oficiales serán evaluados constantemente de forma incógnita. Es decir, en cualquier momento podrán estar siendo evaluados sin ser notificados con la intención de ver su desempeño en un turno ordinario sin que sea modificado por interés. Los oficiales que exigen o piden ascensos injustificados “Llevo mucho tiempo” serán aplazados en su evaluación. Estas evaluaciones serán tomadas directamente por el Jefe de policía y Sheriff."
                ]}  
              />
    </Content>
