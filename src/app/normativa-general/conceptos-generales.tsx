        ...
        <SectionContent reference='1.0 Rol de Interacción'>
          <SubSectionContent reference='Rol de Interacción'>
            <HeaderContent title='1.0 Rol de Interacción (RDINT)' id='1.0'>
              El <span className='font-bold text-purple-600'>Rol de Interacción (RDINT)</span> es la base de una experiencia inmersiva en el Roleplay. Se refiere a cualquier acción o situación dentro
              del juego que implique una interacción realista entre jugadores, donde cada uno actúe de acuerdo con la personalidad, historia y habilidades de su personaje.
            </HeaderContent>
            ...
            <ContentFooter>
              El objetivo del RDINT es evitar que los jugadores simplemente realicen acciones mecánicas sin una justificación o contexto, fomentando un ambiente en el que cada interacción sea
              significativa y aporte al desarrollo del rol en el servidor.
            </ContentFooter>
          </SubSectionContent>
          <SubSectionContent reference='Acuerdo Entre Facciones'>
            <HeaderContent title='1.0.1 Acuerdo Entre Facciones' id='1.0.1'>
              Las facciones gubernamentales deberán respetar los procedimientos establecidos para cada tipo de rol y colaborar entre sí cuando la situación lo requiera. Es fundamental que trabajen en
              conjunto para garantizar un desarrollo coherente y realista de las escenas. Cualquier intento de ignorar o evitar un procedimiento que implique el apoyo de otra facción será considerado
              una falta dentro del rol y tendrá consecuencias IC. Si esta actitud se mantiene de manera reiterada, la administración tomará medidas disciplinarias contra el responsable, asegurando que
              se cumplan las normativas y se respete la cohesión del roleo dentro del servidor.
              <br />
              Si esta actitud se mantiene de manera reiterada, la administración tomará medidas disciplinarias contra el responsable, asegurando que se cumplan las normativas y se respete la cohesión
          ...
          <SubSectionContent reference='Entornos y Detalles /DO'>
            <HeaderContent title='1.0.3 /DO - Entornos y Detalles' id='1.0.3'>
              Se utiliza para describir elementos del entorno, reacciones físicas, efectos de una acción o preguntas sobre la escena en tercera persona. También se usa para consultar a otros jugadores
              sobre la efectividad de una acción.
            </HeaderContent>
        ...
        <SectionContent reference='1.1 Rol de Interpretación (RDI)'>
          <SubSectionContent reference='Rol de Interpretación (RDI)'>
            <HeaderContent title='1.1 Rol de Interpretación (RDI)' id='1.1'>
              Este se refiere a la capacidad de un jugador para desarrollar y representar su personaje de manera realista y coherente dentro del roleplay. Esto implica actuar según la personalidad,
              historia y circunstancias del personaje, manteniendo la inmersión y respetando las reglas del juego. El RDI también es fundamental en las facciones legales, donde los jugadores deben
              interpretar correctamente a policías, médicos, jueces, entre otros, respetando protocolos y procedimientos que se aplicarían en la vida real. Del mismo modo, en las organizaciones
              delictuales (OD), el rol de interpretación implica actuar de manera acorde al mundo criminal, evitando actitudes exageradas o irreales, como atacar sin planificación, cometer delitos sin
              discreción o actuar como si fueran invencibles.
            </HeaderContent>
          </SubSectionContent>
          <SubSectionContent reference='Nombre del Personaje'>
            <HeaderContent title='1.1.1 Nombre del Personaje' id='1.1.1'>
              El nombre de tu personaje debe cumplir con el formato Nombre y Apellido, asegurando coherencia y realismo. No se permiten nombres inventados que no tengan sentido dentro del rol o que
              rompan la inmersión del juego. Queda estrictamente prohibido el uso de nombres ofensivos, paródicos o que tengan la intención de molestar a otros jugadores. Los nombres deben ser
              apropiados y adecuados al contexto del rol, evitando memes o combinaciones irreales. En caso de que un nombre incumpla estas normas, la administración podrá solicitar un cambio
              inmediato. Si el jugador se niega a hacerlo, se aplicarán sanciones correspondientes, que pueden incluir modificaciones forzadas o restricciones dentro del servidor.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='1.2 In Character (IC)'>
          <SubSectionContent reference='In Character (IC)'>
            <HeaderContent title='1.2 In Character (IC)' id='1.2'>
              ...
              experiencias que el personaje adquiere a lo largo de su desarrollo de historia. También abarca sus habilidades y aptitudes, las cuales deben aprenderse e interpretarse de manera
        ...
        <SectionContent reference='1.3 Out of Character (OOC)'>
          <SubSectionContent reference='Out of Character (OOC)'>
            <HeaderContent title='1.3 Out of Character (OOC)' id='1.3'>
              ...
              exclusivamente al curso del mismo, ya sea informativo, de humor, de reacción a algo que ocurrió en el rol, etc. No deben ser utilizados para pedir ayuda, para hablar de personajes que no
              están en el rol, para hablar de cosas que no tienen que ver con el rol, etc.
            </HeaderContent>
        ...
        <SectionContent reference='1.4 Metagaming'>
          <SubSectionContent reference='Metagaming'>
            <HeaderContent title='1.4 Metagaming (MG)' id='1.4'>
              Se refiere a cuando un jugador usa información externa o conocimientos fuera del juego, para influir en las acciones o decisiones dentro del juego. Es decir, si un jugador sabe algo
              fuera del rol, como una charla entre jugadores, y luego su personaje actúa como si ya supiera esa información, es metagaming. Este tipo de comportamiento rompe la inmersión y hace que la
              experiencia del juego sea menos auténtico, ya que el personaje actúa con conocimientos que no tendría en su mundo, lo que puede arruinar la dinámica y la sorpresa en la historia.
            </HeaderContent>
          </SubSectionContent>
        ...
        <SectionContent reference='1.5 PowerGaming (PG)'>
          <SubSectionContent reference='1.5 PowerGaming (PG)'>
            <HeaderContent title='1.5 PowerGaming (PG)' id='1.5'>
              El powergaming (PG) es cuando un jugador actúa de forma exagerada o irrealista dentro del juego, haciendo cosas que, aunque posibles en el mundo virtual, no tendrían sentido ni lógica en
              la vida real. Esto se refiere a realizar acciones sin considerar las consecuencias o la coherencia del rol. Por ejemplo, un jugador podría hacer que su personaje maneje un vehículo a
              altísimas velocidades sin que el vehículo sufra daños, o intentar saltar de manera acrobática sin tener en cuenta lo que realmente pasaría en una situación así. Sin embargo, esto no
              significa que no se puedan hacer cosas fuera de lo común; la clave está en hacerlo de manera realista, es decir, si vas a realizar una acción fuera de lo habitual, debes "rolearlas" de
              forma que tenga sentido dentro del contexto y considere las consecuencias, como daños al vehículo o al personaje. El powergaming ocurre cuando se ignoran esas reacciones lógicas y se
              actúa solo con el objetivo de ser más poderoso o lograr más sin importar las reglas del juego o la historia.{" "}
            </HeaderContent>
          </SubSectionContent>
          ...
          <SubSectionContent reference='1.5.2 Sobrecarga del Inventario'>
            <HeaderContent title='1.5.2 Sobrecarga del Inventario' id='1.5.2'>
              Esto significa que no puedes llevar una cantidad excesiva de objetos sin usar un bolso o contenedor adecuado. Esta regla aplica para todos y es esencial para mantener el equilibrio y el
              realismo en el juego. Por ejemplo, un usuario no podría llevar múltiples armas de distintos calibres y sus municiones, multiples chalecos o cantidades exageradas de comida. Esto aplica
              para Facciones y ODs.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='1.6 Bunny Jump (BJ)'>
          <SubSectionContent reference='Bunny Jump (BJ)'>
            <HeaderContent title='1.6 Bunny Jump (BJ)' id='1.6'>
              La técnica del Bunny Jump implica saltar repetidamente de manera continua mientras se avanza en una dirección específica. Al hacerlo, se puede aumentar la velocidad de movimiento y
              realizar movimientos más rápidos en comparación con simplemente correr. Se deberá evitar la utilización de esta técnica para obtener ventaja en situaciones donde rompa la lógica o
              coherencia de las acciones del personaje, también para evitar situaciones donde pueda obtener ventaja en conflictos armados, donde utilizando esta técnica podría evitar balas.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='1.7 Rol de Entorno (RDE)'>
          <SubSectionContent reference='1.7 Rol de Entorno (RDE)'>
            <HeaderContent title='1.7 Rol de Entorno (RDE)' id='1.7'>
              Este consiste en interpretar y reaccionar de manera realista a todo lo que rodea a tu personaje dentro del juego, incluso cuando no hay otros jugadores presentes. Esto implica considerar
              elementos como el tráfico, las condiciones climáticas, la presencia de cámaras de seguridad o posibles testigos. Por ejemplo, si tu personaje sufre un accidente automovilístico en una
              zona urbana, no sería realista simplemente marcharse sin asumir que alguien podría haber llamado a las autoridades o que habría consecuencias. Del mismo modo, conducir una motocicleta
              bajo la lluvia a alta velocidad sin ninguna dificultad no reflejaría la realidad. También es importante tener en cuenta que, si realizas actos delictivos, siempre habrán testigos que
              puedan presenciar lo ocurrido. Si cometes un crimen en un hospital, debes asumir que hay pacientes, médicos, enfermeros y camilleros que podrían verlo y reaccionar. Lo mismo sucede en
              una comisaría: no sería lógico que un personaje simplemente pueda reducir y atacar a un oficial sin considerar que hay otros policías presentes en el edificio. En esencia, el rol de
              entorno ayuda a mantener la coherencia del juego, asegurando que las acciones de los personajes se desarrollen dentro de un marco lógico y creíble.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='1.8 Player Kill (PK)'>
          <SubSectionContent reference='Player Kill (PK)'>
            <HeaderContent title='1.8 Player Kill (PK)' id='1.8'>
              Es cuando el personaje pierde la memoria de los eventos que llevaron a su muerte o inconsciencia dentro del rol, sin que esto signifique su eliminación total del juego. Siguiendo el
              ejemplo, si tu personaje queda en coma y es reanimado por un médico, deberás rolear una pérdida de memoria parcial. No podrás recordar quién te atacó, qué sucedió exactamente, cómo
              ocurrió, cuándo pasó ni dónde estabas en los últimos 15 minutos antes de ser abatido. Esto evita que los jugadores busquen venganza o retomen la situación como si nada hubiera pasado,
              manteniendo la coherencia del roleplay.
            </HeaderContent>
        ...
        <SectionContent reference='1.9 Revenge Kill (RK)'>
          <SubSectionContent reference='Revenge Kill (RK)'>
            <HeaderContent title='1.9 Revenge Kill (RK)' id='1.9'>
              ...
              adecuado. Por ejemplo, si tu personaje fue abatido y luego reanimado por un médico, según las reglas del PK, no debería recordar quién lo atacó ni cómo sucedió. Sin embargo, si decides
              volver al lugar del incidente y tomar represalias contra la persona que te abatió estarías cometiendo Revenge Kill, ya que tu personaje no debería tener conciencia de lo ocurrido.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='2.0 Player Kill Total (PKT)'>
          <SubSectionContent reference='Player Kill Total (PKT)'>
            <HeaderContent title='2.0 Player Kill Total (PKT)' id='2.0'>
              Este es una ramificación del PK. Es cuando un personaje pierde por completo la memoria de ciertos eventos importantes de su vida, olvidando su historia, relaciones y cualquier rol que
              esté directamente relacionado con su asesinato. A diferencia del CK (Character Kill), el personaje no muere definitivamente, sino que sigue existiendo, pero sin recordar los hechos que
              lo llevaron a esa situación. Este tipo de pérdida de memoria también se aplica cuando un personaje ha estado involucrado en grandes roles que están fuertemente conectados con su
              asesinato. Por ejemplo, si la mayoría de sus interacciones y desarrollo giraban en torno a ese conflicto, o si pertenecía a la misma organización que lo eliminó, es necesario que olvide
              todos esos roles para poder continuar sin afectar la coherencia del roleplay.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='2.2 Character Kill (CK)'>
          <SubSectionContent reference='Character Kill (CK)'>
            <HeaderContent title='2.2 Character Kill (CK)' id='2.2'>
              Es la <b className='text-purple-700'>MUERTE TOTAL Y DEFINITIVA</b> de tu personaje, lo que significa que ya no podrá ser utilizado nuevamente y su historia llega a su fin de manera
              permanente. A diferencia del <b>PK (Player Kill)</b>, donde solo se pierde la memoria de ciertos eventos, el CK implica que el personaje desaparece del mundo del juego, obligando al
              jugador a crear uno nuevo si desea seguir participando. Al realizar un CK no podrás volver a crearte un personaje con el mismo nombre y características que tenía el anterior, tendrá que
              ser totalmente diferente en todos los aspectos. Lo único que se podrá mantener será el sexo del personaje.
            </HeaderContent>
        ...
        <SectionContent reference='2.5 Vehicle Deathmatch (VDM)'>
          <SubSectionContent reference='Vehicle Deathmatch (VDM)'>
            <HeaderContent title='2.5 Vehicle Deathmatch (VDM)' id='2.5'>
              Este ocurre cuando un jugador usa un vehículo para atropellar, dañar o matar a otros sin una razón válida dentro del rol. Esto incluye embestir a personajes sin justificación, atropellar
              repetidamente sin dar oportunidad de reacción o usar el vehículo como arma principal sin contexto adecuado.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='2.9 Evasión de Rol'>
          <SubSectionContent reference='Evasión de Rol'>
            <HeaderContent title='2.9 Evasión de Rol' id='2.9'>
              La evasión de rol ocurre cuando un jugador evita, interrumpe o abandona una situación de roleplay de manera intencional para no enfrentar las consecuencias IC de sus acciones. En caso de
              problemas de Internet o desconexión por fuerza mayor, se establece que los jugadores deben continuar el rol inmediatamente al re-conectarse y seguir adelante normalmente.
            </HeaderContent>
            ...
            <ContentFooter>
              Incluso si la persona que tienes delante está incumpliendo la normativa, tú no debes salirte nunca ni decirle a él/ella que está incumpliendo la normativa. No hagas acciones que
              provoquen a otras personas a romper el roleplay. Cualquier caso de incumplimiento de normas o reporte hacia otra persona debe hacerse mediante el sistema de reportes del discord y
              adjuntando pruebas que respalden la denuncia. Nunca se debe hablar fuera del personaje (OOC) dentro del juego para tratar estos asuntos.
            </ContentFooter>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='3.0 Actos Sexuales / Violaciones'>
          <SubSectionContent reference='Actos Sexuales / Violaciones'>
            <HeaderContent title='3.0 Actos Sexuales / Violaciones' id='3.0'>
              Queda terminantemente prohibido la realización de cualquier rol sexual de manera forzosa. Los actos sexuales únicamente podrán tener lugar con el consentimiento pleno de todos los
        ...
        <SectionContent reference='3.1 Abuso de Mecánicas, Bugs, Exploits'>
          <SubSectionContent reference='Abuso de Mecánicas, Bugs, Exploits'>
            <HeaderContent title='3.1 Abuso de Mecánicas, Bugs, Exploits' id='3.1'>
              Se encuentra estrictamente prohibido el abuso de cualquier mecánica del juego para beneficio propio. Queda completamente prohibido el uso de bugs o exploits en su beneficio, siendo o no
              conscientes del uso de el mismo, cualquier sistema que esté implementado por error y se use para favorecerse de forma IC consiguiendo un beneficio considerable para si mismo o un tercero
              será sancionado. El uso de las animaciones <b>/walk flee3, /walk flee4, /walk flee5</b> o cualquiera de las variantes de la misma que genere una ventaja a la hora de correr será{" "}
              <b className='text-red-500'>sancionada</b> de manera administrativa.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='3.2 Fair Play'>
          <SubSectionContent reference='Fair Play'>
            <HeaderContent title='3.2 Fair Play' id='3.2'>
              El Fair Play se refiere al juego limpio y al comportamiento ético de los participantes en un entorno de roleplay. Es un principio fundamental que promueve la igualdad, el respeto y la
              diversión equitativa para todos los jugadores involucrados. Toda la normativa escrita en el presente documento de El Club RP busca el fair play entre todo usuario.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='3.3 Fear Play'>
          <SubSectionContent reference='Fear Play'>
            <HeaderContent title='3.3 Fear Play' id='3.3'>
              El Fear Play en el roleplay es el concepto que implica interpretar de manera realista el miedo de un personaje ante situaciones de peligro, tensión o amenaza. Esto significa que los
              personajes no deben reaccionar de manera irreal o invulnerable ante eventos que pondrían en riesgo su vida o bienestar.
            </HeaderContent>
            <Content title='Ejemplos de Fear Play:' id='3.3.1' spaced>
              <ListItemContent title='Estás siendo amenazado:' description='Si estás siendo amenazado con un arma, no deberías reaccionar de manera irrealista como si no te importara tu vida.' />
              <ListItemContent
        ...
        <SectionContent reference='3.4 Múltiples Pj (SLOTS)'>
          <SubSectionContent reference='Múltiples Pj (SLOTS)'>
            <HeaderContent title='3.4 Múltiples Pj (SLOTS)' id='3.4'>
              No está permitido la creación de personajes cuyas historias o escenarios se entrelacen demasiado o destaquen en exceso, ni compartir los mismos vínculos con otros. Así como tampoco podrá
              tener un personaje perteneciente a una OD y otro perteneciente a una facción legal como la LSPD o la LSSD. Esto busca fomentar la diversidad de tramas y experiencias dentro del servidor
              de roleplay, evitando que los personajes estén demasiado conectados o repitan narrativas similares.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='3.7 Cryreport'>
          <SubSectionContent reference='Cryreport'>
            <HeaderContent title='3.7 Cryreport' id='3.7'>
              Se considera Cryreport cuando un jugador realiza reportes constantes y sin fundamentos válidos, con el único propósito de quejarse sin razones justificadas o para perjudicar a otros
              jugadores.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='3.8 Vacíos legales'>
          <SubSectionContent reference='Vacíos legales'>
            <HeaderContent title='3.8 Vacíos legales' id='3.8'>
              ...
              <br />
              <br />
              En caso de dudas o situaciones no reguladas, el equipo administrativo tendrá la última palabra para determinar la acción adecuada. Se recomienda no abusar de estos vacíos, ya que el mal
              uso de mecánicas no reguladas puede ser sancionado bajo la norma de Lógica de Rol o Sentido Común. Si se detecta un vacío legal, se evaluará su inclusión en futuras actualizaciones de la
              normativa.{" "}
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
