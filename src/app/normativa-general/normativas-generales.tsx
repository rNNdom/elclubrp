      ...
      <div>
        ...
        <div className='bg-blue-50 border-l-4 border-blue-400 p-4 mb-6'>
          <p className='text-gray-800 leading-relaxed'>
            Las siguientes normativas generales establecen las reglas fundamentales para mantener un ambiente de juego respetuoso, justo y divertido para todos los participantes del servidor.
          </p>
        </div>
      </div>
      ...
      <div className='grid gap-4'>
        <SectionContent reference='1. Respeto y Cortesía'>
          <SubSectionContent reference='Respeto y Cortesía'>
            <HeaderContent title='1. Respeto y Cortesía' id='1.'>
              Se espera que todos los miembros de la comunidad se traten con respeto y cortesía en todo momento. Es importante recordar que dentro del juego, los personajes pueden tener conductas no
              tan correctas, pero estas deben ser interpretadas dentro del contexto del rol y presentadas de manera adecuada.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='3. Uso de los Canales de Chat'>
          <SubSectionContent reference='Uso de los Canales de Chat'>
            <HeaderContent title='3. Uso de los Canales de Chat' id='3.'>
              Los canales de comunicación deben utilizarse de manera apropiada para mantener la inmersión y el orden en el servidor.
            </HeaderContent>
            <Content title='Reglas por canal:' id='Canales Chat' spaced>
              <ListItemContent
                title='Canal Twitter (IC)'
                description='Destinado exclusivamente para la comunicación dentro del rol. Queda prohibido fomentar la toxicidad o usarlo para discusiones fuera de contexto.'
              />
              <ListItemContent title='Canales /me y /do' description='Deben utilizarse únicamente para sus respectivos propósitos narrativos, asegurando el correcto desarrollo del rol.' />
              <ListItemContent
                title='Canal OOC'
                description='Su uso se limita a señalar aspectos puntuales que requieran aclaración inmediata. No se permiten reclamos ni discusiones en este canal; cualquier inconveniente debe resolverse mediante un reporte formal.'
              />
            </Content>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='4. Prohibición de Explotación de Errores o Trucos'>
          <SubSectionContent reference='Prohibición de Explotación de Errores o Trucos'>
            <HeaderContent title='4. Prohibición de Explotación de Errores o Trucos' id='4.'>
              Queda prohibido el uso de errores del juego, trampas o cualquier otro método que otorgue ventajas desleales. Los jugadores que detecten fallos deben informar de inmediato al equipo del
              servidor.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='5. Juego Justo'>
          <SubSectionContent reference='Juego Justo'>
            <HeaderContent title='5. Juego Justo' id='5.'>
              Está prohibido el uso de hacks, cheats o cualquier software que otorgue ventajas desleales. Esto incluye complementos tales como Citizen, mira externa, aimbots, trasers, etc. La
              infracción de esta norma resultará en una amonestación verbal o expulsión permanente.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='6. Personajes y Comportamiento'>
          <SubSectionContent reference='Personajes y Comportamiento'>
            <HeaderContent title='6. Personajes y Comportamiento' id='6.'>
              Los jugadores deben actuar de manera consistente con el entorno del juego. No se permite la creación de personajes que promuevan el odio, la violencia, o que interfieran de forma
              significativa con la experiencia de otros jugadores.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='7. Interpretación del Rol'>
          <SubSectionContent reference='Interpretación del Rol'>
            <HeaderContent title='7. Interpretación del Rol' id='7.'>
              Mantén la coherencia con el rol en todo momento. Actúa y responde de acuerdo con las circunstancias y características del personaje que estás interpretando. Esto incluye su acento,
              historia, origen y personalidad, asegurando así una representación auténtica y realista.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='Uso de moduladores de voz'>
          <SubSectionContent reference='Uso de moduladores de voz'>
            <HeaderContent title='Uso de moduladores de voz' id='mod'>
              En nuestro servidor está permitido y respaldado el uso de moduladores de voz para aquellas personas que decidan rolear un personaje de sexo opuesto. No se tolerará bajo ninguna
              circunstancia el acoso, burla o discriminación hacia los jugadores que hagan uso de estas herramientas. Cualquier actitud negativa de este tipo será considerada una falta grave y
              conllevará sanciones estrictas.
              <br />
              <br />
              Queremos dejar en claro que en esta comunidad no se promueve la homofobia, la transfobia ni ningún tipo de discriminación. El respeto mutuo es un pilar fundamental para el correcto
              desarrollo del rol y la sana convivencia entre todos los jugadores.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='8. Protección de Información Personal'>
          <SubSectionContent reference='Protección de Información Personal'>
            <HeaderContent title='8. Protección de Información Personal' id='8.'>
              Está prohibido divulgar la información personal de otros jugadores sin su autorización explícita. Esto incluye nombres reales, direcciones, números de teléfono, correos electrónicos u
        ...
        <SectionContent reference='9. Cumplimiento de las Reglas'>
          <SubSectionContent reference='Cumplimiento de las Reglas'>
            <HeaderContent title='9. Cumplimiento de las Reglas' id='9.'>
              Todos los jugadores deben adherirse a estas normas en todo momento. El incumplimiento puede resultar en sanciones que van desde advertencias hasta la expulsión permanente del servidor,
              dependiendo de la gravedad de la falta y del historial del jugador.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='10. Eventos del Servidor'>
          <SubSectionContent reference='Eventos del Servidor'>
            <HeaderContent title='10. Eventos del Servidor' id='10.'>
              Participar en eventos organizados por los administradores del servidor, tales como misiones especiales, incursiones coordinadas y desafíos únicos es todo voluntario.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='12. Resolución de Disputas'>
          <SubSectionContent reference='Resolución de Disputas'>
            <HeaderContent title='12. Resolución de Disputas' id='12.'>
              Los administradores tienen la autoridad para resolver conflictos y tomar decisiones en favor del bienestar del servidor.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='13. Actualizaciones y Mantenimiento'>
          <SubSectionContent reference='Actualizaciones y Mantenimiento'>
            <HeaderContent title='13. Actualizaciones y Mantenimiento' id='13.'>
              Mantén el servidor actualizado y realiza el mantenimiento necesario para garantizar una experiencia de juego sin problemas.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='14. Prohibición de Abandonar el Juego mediante F8 + Quit'>
          <SubSectionContent reference='Prohibición de Abandonar el Juego mediante F8 + Quit'>
            <HeaderContent title='14. Prohibición de Abandonar el Juego mediante F8 + Quit' id='14.'>
              Está estrictamente prohibido abandonar el juego utilizando el comando F8 + Quit durante cualquier situación de rol activa, como enfrentamientos, persecuciones, interacciones sociales
              importantes o cualquier otra circunstancia que pueda afectar la experiencia de otros jugadores.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='15. Sanciones'>
          <SubSectionContent reference='Sanciones'>
            <HeaderContent title='15. Sanciones' id='15.'>
              El incumplimiento de esta norma será sancionado según la gravedad, pudiendo incluir advertencias, suspensión temporal de la cuenta o expulsión definitiva de la comunidad.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='16. Prohibición de Ataques a Propiedades sin Rol Previo'>
          <SubSectionContent reference='Prohibición de Ataques a Propiedades sin Rol Previo'>
            <HeaderContent title='16. Prohibición de Ataques a Propiedades sin Rol Previo' id='16.'>
              No está permitido atacar casas o comunidades sin haber desarrollado previamente un rol significativo que justifique dicho ataque.
            </HeaderContent>
          </SubSectionContent>
        </SectionContent>
        ...
        <SectionContent reference='17. Límite de Velocidad en Ciudad y Actos Delictuales'>
          ...
          <SubSectionContent reference='Reglas en Actos Delictuales'>
            ...
            <Content title='En situaciones de tiroteo:' id='19.1.' spaced>
              <div className='bg-red-50 border-l-4 border-red-400 p-4 mb-4'>
                <p className=' leading-relaxed '>
                  Queda estrictamente prohibido realizar las dos acciones mostradas en las imágenes adjuntas. Estas acciones pueden afectar la hitbox de los personajes en determinadas circunstancias,
                  lo que genera una ventaja injusta al reducir el impacto de las balas y provocar el tanqueo de disparos.
                </p>
              </div>
