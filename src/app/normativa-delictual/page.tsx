  ...
  const navigationSections = [
    {
      ...
      items: [
        ...
        { id: "9", label: "Vehiculos Modificados", level: 0 },
        { id: "10", label: "Búsqueda De Vehiculos", level: 0 },
        { id: "11", label: "Búsqueda De Sujetos", level: 0 },
        { id: "12", label: "Límite de Velocidad en Ciudad y Actos", level: 0 },
        { id: "13", label: "Control y Fiscalización", level: 0 },
        { id: "14", label: "Reglas en Actos Delictuales", level: 0 },
        { id: "15", label: "Persecuciones y Cruce de Frontera", level: 0 },
        { id: "16", label: "Medios de Cruce Alternativos", level: 0 },
        { id: "17", label: "Uso de Vestimenta y Fiscalización Policial", level: 0 },
        { id: "18", label: "Intento de Detención Vehicular con Fines Delictuales", level: 0 },
        { id: "19", label: "Enfrentamientos Armados cerca de Lugares con RDE (Rol de Entorno) Gubernamental", level: 0 },
        { id: "20", label: "Tiroteos en Vehículos", level: 0 },
        { id: "21", label: "Prioridades y Procedimientos en Entornos Delictuales con Múltiples Sujetos y Vehículos", level: 0 },
        { id: "22", label: "Para evitar confusiones y asegurar un desarrollo claro del rol, el entorno enviado debe ser lo más detallado posible, especificando", level: 0 },
        { id: "23", label: "Negociaciones", level: 0 },
        { id: "24", label: "Secuestros", level: 0 },
        { id: "25", label: "Tipos de Secuestro", level: 0 },
        { id: "26", label: "Reglas Generales", level: 0 },
      ]
    },
